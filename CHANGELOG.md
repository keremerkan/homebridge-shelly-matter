...
- **RPC over UDP** for Gen 2+ devices (`rpcOverUdp`, off by default): devices configured to send their updates to `<homebridge-ip>:8585` report over UDP instead of a WebSocket, the simplest transport for Gen 2+ battery devices.
