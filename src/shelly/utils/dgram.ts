...
// AnsiLogger imports
import { AnsiLogger, BLUE, db, idn, LogLevel, nf, rs, TimestampFormat } from './logger.js';
...
export class Dgram extends EventEmitter<DgramEvents> {
  // Local change: upstream reads these from matterbridge's CLI flags; inside Homebridge they are plain defaults.
  verbose = false;
  debug = false;
  silent = false;
  log: AnsiLogger;
